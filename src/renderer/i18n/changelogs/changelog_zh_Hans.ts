const changelog = `
## v1.23.5 - 2026.09.24
1. 修复应用未启动时，通过外部链接一键添加 MCP 服务无法打开预填配置窗口的问题

## v1.23.4 - 2026.09.23
1. 工作模式的助手回复现在可以编辑最后一段输出
2. 修复图片创作历史记录不完整时页面白屏或无法继续加载的问题
3. 修复新建话题后撤销会误删原来聊天记录的问题
4. 修复九键输入过程中粘贴后输入框出现一串数字的问题

## v1.23.3 - 2026.09.17
1. 回复中断时会说明原因，并提示如何继续
2. 修复 DeepSeek V4.1 Flash 无法显示思考开关和思考强度的问题
3. 新增土耳其语界面
4. 图像生成的模型选择器会显示模型图标
5. 改善移动端和网页端使用 OpenCode Go / Zen 的网络兼容性
